...
import com.sitharaj88.sensorwatcher.model.Temperature

class TemperatureSensor(context: Context) : SensorSpec<Temperature> {
    override val sensorType: Int = SensorType.TEMPERATURE.sensor
    override val requiredPermission: String? = SensorType.TEMPERATURE.requiredPermission
    ...
    override fun processSensorData(values: FloatArray): Temperature {
        return Temperature(values[0])
    }

    override fun createSensor(context: Context): BaseSensor<Temperature> {
