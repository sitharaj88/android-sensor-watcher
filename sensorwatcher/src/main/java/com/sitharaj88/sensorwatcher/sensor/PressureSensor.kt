...
import com.sitharaj88.sensorwatcher.model.Pressure

class PressureSensor(context: Context) : SensorSpec<Pressure> {
    override val sensorType: Int = SensorType.PRESSURE.sensor
    override val requiredPermission: String? = SensorType.PRESSURE.requiredPermission
    ...
    override fun processSensorData(values: FloatArray): Pressure {
        return Pressure(values[0])
    }

    override fun createSensor(context: Context): BaseSensor<Pressure> {
